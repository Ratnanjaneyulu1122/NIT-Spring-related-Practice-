...
public class EmployeeDaoImpl extends JdbcDaoSupport implements EmployeeDao {
	...
	private String INSERT = "insert into student.employee(name,address,salary,email) values (?,?,?,?);";
	private String DELETE = "delete from student.employee where id=?";
	private String GET_ONE = "select * from student.employee where id=?";
	private String UPDATE = "update student.employee set name=?, address=?, salary=? , email=? where id=?";
	...
	public void saveEmpoloyee(Employee emp) {
		getJdbcTemplate().update(INSERT, emp.getName(), emp.getAddress(), emp.getSalary(), emp.getEmail());
	...
	public void updateEmpoloyee(Employee emp) {
		getJdbcTemplate().update(UPDATE, emp.getName(), emp.getAddress(), emp.getSalary(), emp.getEmail(), emp.getId());
	}
